...
const newsData = [
  {
    date: "2026.5.27",
    label: "重要",
    title: "随時、参加フォームを公開します。",
    body: "このサイトでも参加フォームを公開します。いずれか一つの方法でご回答ください。",
  },
  {
    date: "2026.5.27",
    label: "参加費",
    title: "参加費が仮で決定しました（¥10,000）",
    body: "飲み放題・食事込みで ¥10,000(仮) となりました。払込先は支払いページをご確認ください。",
  },
  {
    date: "2026.5.27",
    label: "会場",
